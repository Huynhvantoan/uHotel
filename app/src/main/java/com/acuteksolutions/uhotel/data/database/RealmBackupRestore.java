...
public class RealmBackupRestore {
  ...
  private String EXPORT_REALM_FILE_NAME = "kct_box.realm";
  private String IMPORT_REALM_FILE_NAME = "kct_box.realm"; // Eventually replace this if you're using a custom db name
  ...
  public RealmBackupRestore(Activity activity, RealmManager databaseRealm) {
    this.realm = databaseRealm.getRealmDB();
